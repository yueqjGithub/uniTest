			...
			<view class="head-info border-box pa-md flex-column flex-jst-start flex-ali-center">
				...
				<view class="full-width head-detail flex-column flex-jst-start flex-ali-end">
					...
					<view class="full-width flex-row flex-jst-btw flex-ali-end">
						<text class="flex-3 text-18 text-bold text-center">{{startTime}}</text>
						<view class="flex-2 text-14 text-primary trap-num text-center pa-col-sm border-box flex-row flex-jst-center">
						...
						<text class="flex-3 text-18 text-bold text-center">{{endTime}}</text>
					...
					<view class="full-width flex-row flex-jst-btw flex-ali-start ma-top-5">
						<text class="flex-3 text-14 text-center">
