	...
	<view class="page-container bg-grey">
		<view class="head-container flex-row flex-jst-center flex-ali-center">
			<view class="phone-container">
				...
				<u-input v-model="phone" class="text-white" :custom-style="{color: '#ffffff', fontSize: phone ? '28px' : '20px'}" :placeholder="numberTip"
				 type="number" :placeholder-style="placeholderStyle"></u-input>
