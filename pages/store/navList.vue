<template>
	<view class="nav-container flex-row flex-jst-btw flex-ali-center">
		<view class="nav-item flex-column flex-jst-btw flex-ali-center" v-for="k in navList" :key="k.type_id">
...
export default {
	...
	data () {
		return {
			typeList: [
				{name: 'type', icon: 'weibiaoti--35', type_id: 1, start_bg: '#FF4B4B', end_bg: '#FF9696'},
				{name: 'discount', icon: 'weibiaoti--46', type_id: 3, start_bg: '#FF9632', end_bg: '#FFD232'},
				{name: 'suggestion', icon: 'weibiaoti--34', type_id: 2, start_bg: '#00AFFF', end_bg: '#00D7FF'}
			]
		}
	},
	computed: {
