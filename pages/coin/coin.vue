		...
		data() {
			return {
				...
				menuList: [
					...
					{ keyName: 'order', iconName: 'weibiaoti--33', color: '#3498DB', path: '/pullOtherPage/pullOrder/pullOrder' },
					...
					{ keyName: 'top', iconName: 'weibiaoti--46', color: '#E74C3C', path: '/pullOtherPage/pullHot/pullHot' },
				]
			}
		},
		watch: {},
